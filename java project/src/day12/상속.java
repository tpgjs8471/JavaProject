...
public class 상속 {
	...
	public static void main(String[] args) {
		 ...
		 * 상속을 한느 이우: 재사용을 해서 중복코드를 줄이기 위한 것.
		 ...
		 * }
		 * 
		 * 상속을 받으면 부모의 멤버변수와 멤버 메서드를 사용 할 수 있다.
		 * 접근제한자가 private이면 자식클래스에서도 접근 불가능!
		 * 접근제하낮 protected : 상속받는 자식에게 허용하는 제어자
		 */
		...
		b.setB(200);
		b.setC(300);
		b.num=500;    //제어자가 protected이기 때문에 직접접근 가능
		b.setD(10);
		b.setE(20);
		b.setF(30);
		b.print();
...
class B extends A{
	...
	//오버드라이브 : 부모의 메서드를 가져와서 재정의하는 것을 의미
